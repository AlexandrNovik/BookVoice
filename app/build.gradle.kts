...
android {
    ...
    defaultConfig {
        applicationId = "com.aliak.bookvoice"
        versionCode = GeneralVersions.versionCode
        versionName = GeneralVersions.versionName

        compileSdk = GeneralVersions.compileSdk
        minSdk = GeneralVersions.minSdk
        targetSdk = GeneralVersions.targetSdk
